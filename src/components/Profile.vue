<template>
    <div class="overflow-hidden md:max-w-none flex flex-col justify-center items-center font-[Mulish]">
        <!-- header -->
        <div class="md:mt-10 mt-2 md:ml-48 w-[60rem] md:w-full">
            <img class="h-80" src="./../../public/images/page_title_bg.png" alt="headerProfile">
            <div class="relative bottom-52 flex flex-col justify-center items-center">
        ...
        <div class="md:w-[800px] md:ml-48 flex flex-wrap md:block w-full p-2 md:p-0 relative bottom-16">
            ...
            <div class="flex flex-wrap md:justify-between justify-center items-center p-4 mb-8 border-2 border-dashed border-pink-300 rounded-2xl gap-4">
                ...
                <div class="flex flex-wrap items-center gap-2 cursor-pointer"> 
                    <button class="py-5 px-4 bg-purple-400 text-white rounded-2xl font-bold shadow-lg hover:scale-105 hover:bg-blue-500 duration-200 hover:shadow-xl"> Change Account</button>
                    <button class="py-5 px-4 bg-cyan-400 text-white rounded-2xl font-bold shadow-lg hover:scale-105 hover:bg-cyan-500 duration-200 hover:shadow-xl"> Change Role</button>
                </div>
            </div>
            <!-- user changes -->
